...
| `DomeSpec.drive_m` | `1` | stipulated | free, and pinned to drive_stalk from above: the drive asserts one number, and an edge stalk wider than the stalk it carries carries nothing extra. Never varied in any run | docs/spec/06-graph-topology.md, Dimensions | — | `src/patchworks/graph.py` |
