...
| `DEFAULT_GAMMA` | `1.0` | stipulated | free in (0, 1] and held at the ceiling because nothing derives a lower value: #206 declined a ramp permanently and withdrew the decline on a permanently lower value, which is #205's to weigh | docs/adr/0019-construction-nominates-the-run-decides.md | — | `src/patchworks/tick.py:96` |
