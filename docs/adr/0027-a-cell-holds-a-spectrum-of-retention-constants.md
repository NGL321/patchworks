# ADR-0027: A cell holds a spectrum of retention constants, learned and not placed
...
Placement is not rejected on argument — **it has already been tried and has already failed on
measurement.** The construction assigns `τ` bands by level; the run reports **0.91 at the apex
against 0.99 at the rim**, no gradient at all. The biases *are* the adapting surface (ADR-0001), they
