...
[![decisions: 26 ADRs](https://img.shields.io/badge/decisions-26_ADRs-blue)](docs/adr/)
...
> down — twelve spec files, twenty-six decision records — and the build is complete: the sandbox,
...
| [`docs/adr/`](docs/adr/) | Twenty-six decisions that needed a reason on the record. |
