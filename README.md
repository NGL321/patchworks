...
[![decisions: 31 ADRs](https://img.shields.io/badge/decisions-31_ADRs-blue)](docs/adr/)
...
> down — twelve spec files, thirty-one decision records — and the build is complete: the sandbox,
...
*persistence alone* — no schedule, no gate, no rate parameter per unit — is, as far as twenty-five
...
| [`docs/adr/`](docs/adr/) | Thirty-one decisions that needed a reason on the record. |
