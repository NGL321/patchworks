...
[![decisions: 30 ADRs](https://img.shields.io/badge/decisions-30_ADRs-blue)](docs/adr/)
...
> down — twelve spec files, thirty decision records — and the build is complete: the sandbox,
...
| [`docs/adr/`](docs/adr/) | Thirty decisions that needed a reason on the record. |
