...
[![decisions: 32 ADRs](https://img.shields.io/badge/decisions-32_ADRs-blue)](docs/adr/)
...
> down — twelve spec files, thirty-two decision records — and the build is complete: the sandbox,
...
*persistence alone* — no schedule, no gate, no rate parameter per unit — is, as far as twenty-seven
...
| [`docs/adr/`](docs/adr/) | Thirty-two decisions that needed a reason on the record. |
