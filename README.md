...
[![decisions: 27 ADRs](https://img.shields.io/badge/decisions-27_ADRs-blue)](docs/adr/)
...
> down — twelve spec files, twenty-seven decision records — and the build is complete: the sandbox,
...
| [`docs/adr/`](docs/adr/) | Twenty-seven decisions that needed a reason on the record. |
